...
extern sched_class_t pr_sched;
extern sched_class_t strf_sched;
extern sched_class_t prp_sched;
...
static const sched_choice_t available_schedulers[NR_AVAILABLE_SCHEDULERS]= {
    ...
    {PR_SCHED,"PR",&pr_sched},
    {STRF_SCHED,"STRF",&strf_sched},
    {PRP_SCHED,"PRP",&prp_sched}
