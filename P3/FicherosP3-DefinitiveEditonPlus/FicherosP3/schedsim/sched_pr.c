...
static task_t* pick_next_task_pr(runqueue_t* rq)
{
...
static void enqueue_task_pr(task_t* t,runqueue_t* rq, int preempted)
{
...
static task_t* steal_task_pr(runqueue_t* rq)
{
...
sched_class_t pr_sched= {
	.pick_next_task=pick_next_task_pr,
	.enqueue_task=enqueue_task_pr,
	.steal_task=steal_task_pr
};
